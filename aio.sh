...
# package locations
     GITHUB_PREFIX="https://raw.githubusercontent.com/streetster/stora/master/dl/"
     SSHD_LOCATION=$GITHUB_PREFIX"sshd.tar.gz"
     IPKG_LOCATION=$GITHUB_PREFIX"ipkg-opt_0.99.163-10_arm.ipk"
      NFS_LOCATION=$GITHUB_PREFIX"dl/nfs-utils_STORA.tar.gz"
NZBGETWEB_LOCATION=$GITHUB_PREFIX"nzbgetweb-1.4.zip"
  NZBGETD_LOCATION=$GITHUB_PREFIX"nzbgetd"
   RPCLIB_LOCATION=$GITHUB_PREFIX"xmlrpc-2.2.2.tar.gz"
TRANSMISSIOND_LOCATION=$GITHUB_PREFIX"transmission-daemon"
